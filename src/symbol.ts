...
const symbolNames = [
    ...
    "COMP_TYPE", "COMPS", "COND", "CONT_EXCEP", "DECL_COMP", "DEPS",
    "DEST_VAR", "DIR_PATH", "ERROR_EXCEP", "ERROR_TYPE", "EXCEP_TYPE", "EXPR",
    "EXPR_TYPE", "EXPRS", "EXPRS_COMP", "FILE_PATH", "FRAME", "FRAME_ENTRIES",
    "GRADE", "IDENT", "IDENT_COMP", "IDENT_EXPR", "IMPORT_VAR", "INT_COMP",
